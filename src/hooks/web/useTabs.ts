...
export function useTabs(_router?: Router) {
  ...
  async function handleTabAction(
    ...
    switch (action) {
      ...
      case TableActionEnum.CLOSE_CURRENT:
        await tabStore.removeTab(tab || currentTab, router, goPath)
        break
    }
  }
  ...
  return {
    ...
    closeCurrent: (goPath?: string, tab?: RouteLocationNormalized) =>
      handleTabAction(TableActionEnum.CLOSE_CURRENT, tab, goPath),
